...
class ForecastCard extends Component<ForecastCardProps> {
    render() {
        ...
        return (
            <div className="min-w-95% sm:min-w-128 sm:max-w-128 max-w-95% shadow-outer from-secondaryCardPrimary to-secondaryCardSecondary text-textDark flex-1 flex-col items-center rounded-2xl bg-gradient-to-l p-4">
                <ForecastTopBar
